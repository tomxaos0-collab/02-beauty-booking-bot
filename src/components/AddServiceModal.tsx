...
import { X, Sparkles, Scissors, DollarSign, Clock } from "lucide-react";
...
export default function AddServiceModal({
  ...
  const [category, setCategory] = useState<"manicure" | "pedicure" | "extra">("manicure");
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newService: BeautyService = {
      ...
      description: description.trim() || "Профессиональный уход и обработка",
          ...
          <div className="flex items-center justify-between pb-3 border-b border-white/10">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-400">Новая услуга в прайс-лист салона</p>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                type="text"
                required
                placeholder="Японский экологичный маникюр"
                value={name}
            ...
            <div>
              ...
              <select
                ...
                className="w-full py-3 px-4 rounded-2xl bg-[#161826] border border-white/10 text-white text-sm focus:outline-none focus:border-pink-500/60 transition-all font-semibold"
              >
                <option value="manicure">Маникюр</option>
                <option value="pedicure">Педикюр</option>
                <option value="extra">Дизайн / Уход / Снятие</option>
              </select>
            </div>
            ...
            <div>
              ...
              <textarea
                rows={2}
                placeholder="Полный гигиенический уход, полировка и глубокое питание кутикулы..."
                value={description}
